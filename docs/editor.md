...
them is up. The PARs follow the strips' Hue, Saturation, Brightness under a
Color subheading, then what runs across the four under two more: the hue
spread with its shuffle, the LFO spread with its.
